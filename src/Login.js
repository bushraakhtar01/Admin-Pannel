    ...
    render() {  
      ...
      <Example/>
        ...
        return (  
            ...
            <div className="jumbotron " style={{ backgroundImage: 'url(logincover.jpg)',backgroundSize:'cover',width:'98%', height:'120vh'}}>
<div className="container">
            
            <h1 className="display-4" style={{ marginLeft: '25%', fontFamily:'helvatica',textShadow:'3px 3px 3px #c62828' ,letterSpacing:'2px',color:'#ffe0b2'}}>ADMIN LOGIN FORM</h1>
            <hr class="my-4" ></hr>
          </div>
  
  
<div className="jumbotron jumbotron-fluid " style={{width:'52%', height:'80vh',marginLeft:'25%',opacity:'0.7'}}>
